...
echo '<li><a href="https://my.smartpost.ee/new_shipment/" target="_blank">Itella SmartPost</a></li>
<li><a href="https://www.omniva.ee/eng" target="_blank">Omniva</a></li>
<li><a href="https://www.dpd.com/ee/en/" target="_blank">DPD</a></li>
</ul>';
echo 'Estonia, goods are delivered to the nearest parcel locker of SmartPost, Omniva, or DPD. If the item does not fit into the parcel locker, delivery is carried out by courier to the address specified in the order for an additional fee. Courier delivery is available on workdays, and the delivery time is agreed with the customer by phone in advance.<br><br>';
